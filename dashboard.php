...
$sql1 = "SELECT * FROM customorders WHERE createDate = '$today' and custom_status = 1 and product_name = 1";
...
$sql2 = "SELECT * FROM customorders WHERE createDate = '$today' and custom_status = 1 and product_name = 2";
$query2 = $connect->query($sql2);

$totalAmount2 = 0;
while ($result2 = $query2->fetch_assoc()) {

    $totalAmount2 += $result2['amount'];
}
            ...
            <div class="card">
                <div class="cardHeader" style="background-color:#245580;">
                    <h1><?php
                        ...
                        echo $totalAmount + $totalAmount1 + $totalAmount2;
                         ?></h1>
                </div>
        ...
        <div class="col-md-4">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <a href="orders.php?o=manord" style="text-decoration:none;color:black;">
                        Total Milk Sales
                        <span class="badge pull pull-right"><?php echo $totalAmount1; ?></span>
                    </a>
        ...
        <div class="col-md-4">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <a href="orders.php?o=manord" style="text-decoration:none;color:black;">
                        Total Oil Sales
                        <span class="badge pull pull-right"><?php echo $totalAmount2; ?></span>
                    </a>
