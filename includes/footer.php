...
<!-- <button type="button" class="btn btn-primary" onClick="document.location.href='customOrders.php'" id="addCustomOrder" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Custom Order </button> -->
