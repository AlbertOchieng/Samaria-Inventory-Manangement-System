            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown" id="navOrder">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li id="navCustom"><a href="customOrders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Custome Orders</a></li>
                    </ul>
                </li>
                <?php
                ...
                {
                    ?>
                    <li id="navStock"><a href="stock.php"><i class="glyphicon glyphicon-folder-close"></i>  Stocks</a></li>
                    <?php
                }
                ?>
                ...
                <li class="dropdown" id="navSetting">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        {
                            ?>
                            <li id="topNavUser"><a href="Users.php"> <i class="glyphicon glyphicon-plus"></i> Create User</a></li>
                            <?php
                        }
                        ?>
