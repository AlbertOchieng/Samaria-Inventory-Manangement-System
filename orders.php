    ...
    <div class="panel-body">
        ...
        <?php if($_GET['o'] == 'add') {
            ...
            <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="orderDate"  value="<?php echo date('m/d/Y'); ?>" autocomplete="off"  readonly = "readonly" name="orderDate" autocomplete="off" />
                    </div>
                </div> <!--/form-group-->
                <div class="form-group">
                        ...
                        <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                            ...
                            <td style="padding-left:10px";>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="categoryName[]" id="categoryName<?php echo $x; ?>" onchange="getSubCategoryData(<?php echo $x; ?>)" >
                                        <option value="">~~SELECT~~</option>

                                        <?php
                                        $productSql = "SELECT categories.categories_id,categories.categories_name,categories.categories_active ,categories.categories_status  FROM categories WHERE categories_active = 1 AND categories_status = 1";
                            ...
                            <td style="padding-left:25px;">
                                <div class="form-group">
                                    <input type="number" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" 
                                     min="1" name="quantity[]" id="quantity<?php echo $x; ?>" onchange="getTotal(<?php echo $x ?>)" 
        ...
        <?php } else if($_GET['o'] == 'manord') {
            ...
            <form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
                ...
                $sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact,  orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders
                ...
                <table class="table" id="productTable">
                    ...
                    $orderItemSql = "SELECT order_item.order_item_id, order_item.order_id,order_item.categories_id, order_item.product_id, order_item.quantity, order_item.rate, order_item.total FROM order_item WHERE order_item.order_id = {$orderId}";
                        ...
                        <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                            ...
                            <td style="padding-left:10px">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="categoryName[]" id="categoryName<?php echo $x; ?>" onchange="getSubCategoryData(<?php echo $x; ?>)" >
                                       ...
                                       // $productSql = "SELECT order_item.order_item_id, order_item.order_id,order_item.categories_id, order_item.product_id, categories.categories_id FROM order_item INNER JOIN  categories ON order_item.categories_id = categories.categories_id  WHERE order_item.order_id = {$orderId}";

                                        $productSql = "SELECT categories_id, categories_name, categories_active, categories_status FROM categories WHERE categories_active = 1 AND categories_status = 1 ";
                                        $productData = $connect->query($productSql);

                                        while($row = $productData->fetch_array()) {
                                            $selected = "";
                                            if($row[0] == $orderItemData['categories_id']) {
                                                $selected = "selected";
                                            } else {
                                                $selected = "";
                                            }

                                            echo "<option value='".$row[0]."' id='changeProduct".$row[0]."' ".$selected." >".$row[1]."</option>";
                                        } // /while
                            ...
                            <td style="padding-left:25px;">
                                <div class="form-group">
                                    ...
                                    <input type="number" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))"
                                      min="1" name="quantity[]" id="quantity<?php echo $x; ?>" value="<?php echo $orderItemData['quantity']; ?>" onchange="getTotal(<?php echo $x ?>)"  onkeyup="getTotal(<?php echo $x ?>)"
