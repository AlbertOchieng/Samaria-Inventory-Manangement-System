...
if($_POST) {	
  ...
  //  $paymentType 					= $_POST['paymentType'];
   // $paymentStatus 				= $_POST['paymentStatus'];
	...
	$sql = "UPDATE orders SET order_date = '$orderDate', client_name = '$clientName', client_contact = '$clientContact',  total_amount = '$totalAmountValue', discount = '$discount', grand_total = '$grandTotalValue', paid = '$paid', updateDate = '$date',order_status = 1 WHERE order_id = {$orderId}";
	$connect->query($sql);
